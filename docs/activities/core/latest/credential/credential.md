...
Robots can also use these activities to retrieve credentials or simply prompt a human user to introduce his credentials.

All of these activities can be found in the **Toolbox** panel, under **Core > Credentials**.
