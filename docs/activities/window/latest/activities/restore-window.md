...
* **Pick target element\***- Chooses the window to restore down. This activity will generate a string variable (Selector) to specify the location of that field.
