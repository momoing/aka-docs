...
* **Pick target element\***- Chooses the window to attach. This activity will generate a string variable (Selector) to specify the location of that window.
...
* **Output Window (WindowApp)**- The found active window. This field supports only WindowApp variables.
