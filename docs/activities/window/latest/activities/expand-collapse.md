...
* **Pick target element**\* - Chooses the element to expand or collapse. This activity will generate a string variable (Selector) to specify the location of that element.
...
* **Expand Option (Dropdown List)**- Choose to expand the items or collapse  
  **・Expand**: Expand the items’ tree to make all items appear.  
  **・Collapse**: collapse the items’ tree to make all items hide.
