...
* **Pick target element\***- Chooses the element to maximize. This activity will generate a string variable (Selector) to specify the location of that field.
