...
* **Attribute Name (String)**\* - The name of the HTML attribute to be changed.
* **Attribute Value (String)**\* - The value to be set to the specified attribute. This property supports String variable.
...
* **Attribute (String)**\* - The name of the HTML attribute to be changed.
...
* **Value (String)**\* - The value of the specified attribute. This property supports String variable so it must be quoted.
